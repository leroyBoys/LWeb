(function (_0x28c10e, _0x2dc36f, _0x2e9c20) {
    ...
    var _0x18c4d6 = {
        'path': _0x2e9c20.ctx + '/themes/classic/base/',
        ...
        'init': function () {
            var _0x5b19df = this;
            _0x2e9c20(_0x2dc36f)['on']('change', '#skintoolsSidebar', function () {
                _0x5b19df.sidebarEvents(_0x2e9c20(this));
            });
            _0x2e9c20(_0x2dc36f)['on']('click', '#skintoolsNavbar input', function () {
                _0x5b19df.navbarEvents(_0x2e9c20(this));
            });
            _0x2e9c20(_0x2dc36f)['on']('click', '#skintoolsPrimary\x20input', function () {
                _0x5b19df['primaryEvents'](_0x2e9c20(this));
            });
            _0x2e9c20(_0x2dc36f)['on']('change', 'input[name=\x22menuDisplay\x22]', function () {
            ...
            _0x2e9c20(_0x2dc36f)['on']('change', 'input[name=\x22menuTxtIcon\x22]', function () {
            ...
            _0x2e9c20(_0x2dc36f)['on']('change', 'input[name="tabFlag"]', function () {
            ...
            _0x2e9c20(_0x2dc36f)['on']('click', 'button[name='save']', function (_0x5c5fd3) {
                _0x5c5fd3.preventDefault();
                _0x2e9c20.ajax({
                    'url': _0x2e9c20.ctx + '/display/save',
                    'type': 'POST',
            ...
            _0x2e9c20(_0x2dc36f)['on']('click', '#skintoolsReset', function (_0xea1637) {
                _0xea1637.preventDefault();
                var _0x5e6560 = _0x2e9c20('#displayForm').find('[name=\x27user.userId\x27]')['val']() === undefined ? '' : _0x2e9c20('#displayForm').find('[name='user.userId']').val();
                _0x2e9c20.ajax({
                    'url': _0x2e9c20['ctx'] + '/display/reset?user.userId=' + _0x5e6560,
                    'type': 'POST',
                    'dataType': 'JSON',
